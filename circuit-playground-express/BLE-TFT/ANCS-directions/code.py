"""
https://learn.adafruit.com/ancs-gizmo?view=all#circuitpython-on-circuit-playground-bluefruit
...
APP_ICONS = {
    ...
    "com.google.Maps": "/ancs_slack.bmp"
}

# APP_ICONS = {
#     "com.google.Maps": "/ancs_basecamp.bmp"
# }

DIRECTION_ICONS = {
    "right": "/ancs_basecamp.bmp",
    "left": "/ancs_discord"
}
        ...
        while active_connection.connected:
            ...
            if not current_notification and not all_ids and not cleared:
                ...
                if current_notification and current_notification.id in all_ids and \
                    ...
                    if current_notification and current_notification.app_id == "com.google.Maps":
                ...
                if not current_notification or current_notification.id != notif_id:
                    ...
                    text_area = label.Label(terminalio.FONT, text=current_notification.message, color=0xFFFF00)
                    text_group.append(text_area)  # Subgroup for text scaling
                    group.append(text_group)

                    # if current_notification.id == "com.google.Maps":
                    #     app_icon_file = open(DIRECTION_ICONS[direction])
